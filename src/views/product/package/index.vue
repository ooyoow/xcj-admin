  ...
  <div :class="prefixCls">
    ...
    <el-form :class="`${prefixCls}-form-search`" :inline="true" :model="listQuery">
      <el-form-item label="输入搜索">
        <el-input v-model="listQuery.search" clearable @input="handleSearch" placeholder="套餐名称/产品ID搜索"></el-input>
      </el-form-item>
    </el-form>
    <el-table :class="`${prefixCls}-table`" :data="packageList" tooltip-effect="dark">
      ...
      <el-table-column prop="pNum" label="产品ID" show-overflow-tooltip></el-table-column>
      ...
      <el-table-column prop="amount" label="发行量" show-overflow-tooltip></el-table-column>
