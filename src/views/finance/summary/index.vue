  ...
  <div :class="prefixCls">
    ...
    <div class="stats-item">
      ...
      <el-table :data="bigSales" border>
        <el-table-column prop="packageAmount" label="套餐销售总额" align="center" />
        <el-table-column prop="limitCardAmount" label="限次卡销售总额" align="center" />
        <el-table-column prop="couponGiveAmount" label="优惠券赠送总额" align="center" />
        <el-table-column prop="couponSalesAmount" label="优惠券销售总额" align="center" />
      </el-table>
    </div>
    <div class="stats-item">
    ...
    <div class="stats-item">
      ...
      <el-table :data="storeService" border>
        ...
        <el-table-column prop="washAmount" label="洗车量" align="center" />
        <el-table-column prop="servieAmount" label="服务额" align="center" />
      </el-table>
    </div>
    <div class="stats-item">
    ...
    <div class="stats-item">
      ...
      <el-table :data="orderStats" border>
        <el-table-column prop="saleOrderCount" label="销售订单总数" align="center" />
        <el-table-column prop="unServerOrderCount" label="待服务订单总数" align="center" />
        <el-table-column prop="unServerOrderAmount" label="待服务订单总额" align="center" />
        <el-table-column prop="unPaidOrderCount" label="待付款订单总数" align="center" />
        <el-table-column prop="unPaidOrderAmount" label="待付款订单总额" align="center" />
        <el-table-column prop="refundOrderCount" label="退款订单总数" align="center" />
        <el-table-column prop="name" label="退款订单总额" align="center" />
        <el-table-column prop="couponGiveCount" label="优惠劵赠送总数" align="center" />
        <el-table-column prop="couponSaleAmount" label="优惠劵销售总数" align="center" />
      </el-table>
    </div>
  </div>
</template>
