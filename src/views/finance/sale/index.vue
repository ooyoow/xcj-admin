  ...
  <div :class="prefixCls">
    ...
    >
      ...
      <el-form-item label="手机号码">
        <el-input
          v-model="queryOrderParams.phone"
          type="number"
          clearable
          @input="_getOrderList"
        ></el-input>
      ...
      <el-form-item label="产品类型">
        <el-select
          clearable
          v-model="queryOrderParams.pType"
          placeholder="请选择产品类型"
          @input="_getOrderList"
        >
          <el-option
      ...
      >
        <template slot-scope="scope">
          <el-popover
            placement="top"
            trigger="hover"
            @show="getWashDetail(scope.row.orderNo)"
          >
            <div>
              <el-table
                :data="calcWashList()"
                v-loading="washDetail.loading"
              >
                <el-table-column
                  align="center"
                  prop="storeName"
              ...
              <div>
                <el-pagination
                  background
                  @current-change="handleCurrentChange($event, 'washDetail')"
                  :current-page="washDetail.currentPage"
                  :page-size="washDetail.size"
                  layout="total, prev, pager, next, jumper"
                  :total="washDetail.total"
                >
                </el-pagination>
              </div>
            </div>
    ...
    <div :class="`${prefixCls}-pagination`">
      <el-pagination
        ...
        @current-change="handleCurrentChange($event, 'order')"
        :current-page="queryOrderParams.currentPage"
        :page-sizes="[10,20,30, 50]"
        :page-size="queryOrderParams.size"
