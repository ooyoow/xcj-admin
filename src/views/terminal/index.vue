<template>
  <div :class="prefixCls">
    ...
    <el-table :class="`${prefixCls}-table`" ref="multipleTable" :data="terminalList" tooltip-effect="dark" style="width: 100%">
...
export default {
  ...
  created() {
    this.getTerminal(Object.assign({}, this.formSearch, this.listQuery))
  },
  computed: {
    ...mapState({
